...
> ✅ **最後驗證時間**：2026-02-06
> 📡 **驗證來源**：`GET https://api.lingge.app/api/public-config`
...
收益 = 10,000 × $0.0008 = $8/月

如果被召喚 100,000 次 = $80/月
如果被召喚 1,000,000 次 = $800/月
```
...
| **3.2.0** | **2026-02-06** | **分潤比例調整為 Author 80% / Platform 20%** |
...
- 創作者分潤從 90% 調整為 **80%**
- 平台分潤從 10% 調整為 **20%**
- 調整原因：確保平台在計入 Cloud Run 運算成本後仍能健康營運
- 對比業界（Apple 30%、Steam 30%、YouTube 45%），80/20 對創作者仍非常友善
